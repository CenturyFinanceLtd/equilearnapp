                      ...
                      <div className="tab-content">
                        <div id="Course" className="tab-pane fade show active">
                          <div className="description-content">
                            ...
                            <p className="mb-3">
                              The Foundation Plan is designed to give learners a
                              basic, easy-to-understand introduction to the
                              basics of the stock market. The general objective
                              of this program is to help learners understand how
                              financial markets function domestically in India
                              and internationally. It provides a brief overview
                              of the key equity indices, the nitty-gritties of
                              trading and international market behavior. This
                              course lays the groundwork for future investment
                              choices and additional financial education, making
                              it ideal for students, potential traders and
                              anyone new to the stock market.
                            </p>
                            <h3 className="mt-5">Skill You Acquire :</h3>
                            <p>
                              Equity Market || Index || Global Finance ||
                              Trading Platform || Market Trends || Securities
                            </p>
                            ...
                            <div className="row g-4 mb-5">
                              <div className="col-lg-12">
                                <ul className="list-item">
                                  ...
                                  <li>
                                    <i className="fas fa-check-circle"></i>
                                    Relationship between regional and global
                                    market
                                  </li>
                                  <li>
                                    <i className="fas fa-check-circle"></i>
                                  ...
                                  <li>
                                    <i className="fas fa-check-circle"></i>
                                    Key terms applied internationally and Indian
                                    Stock Markets
                                  </li>
                                </ul>
                              </div>
                                ...
                                <div className="accordion-item">
                                  <h2
                                    ...
                                    <button
                                      ...
                                      Module 1 : Learning the Stock Market
                                      Fundamentals
                                    </button>
                                  </h2>
                                  <div
                                    ...
                                    <div className="accordion-body">
                                      <ul>
                                        <li>
                                          Understand the basics of the share
                                          market, like the reasons behind the
                                          change in price. Understand stocks,
                                          indices like Bank Nifty and Nifty 50,
                                          the difference between Intraday and
                                          delivery trade, how to open and
                                          operate a demat account. This enables
                                          you to navigate the Indian Market
                                          while building your base of equity
                                          skills.
                                        </li>
                                      </ul>
                                    </div>
                                ...
                                <div className="accordion-item">
                                  ...
                                  <div
                                    ...
                                    <div className="accordion-body">
                                      <ul>
                                        <li>
                                          Discover the world market - from FTSE
                                          100 to Dow Jones - and how they impact
                                          Indian Trading. Understand the basics
                                          of trading future and options along
                                          with Dollar Index and Gift Nifty.
                                          Discover the difference between
                                          holding and delivery, along with how
                                          the international market impacts your
                                          portfolio.
                                        </li>
                                      </ul>
                                    </div>
                  ...
                  <div className="courses-sidebar-area sticky-style">
                    <div className="courses-items">
                      ...
                      <div className="courses-content">
                        <h3>₹1900 + GST</h3>
                        <p>
                          Learn about Equity, European Market Learn about
