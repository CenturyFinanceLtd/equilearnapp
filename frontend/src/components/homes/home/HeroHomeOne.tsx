                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="hero-content">
                            <span className="wow fadeInUp">Welcome to EquiLearn</span>
                            <h1 className="wow fadeInUp" data-wow-delay=".3s">
                                Interactive Learning
                                Engaging Students in
                                the Digital Age
                            </h1>
                            <h3 className="wow fadeInUp" data-wow-delay=".5s">Get  2800+ Best Quality Online Courses From Equilearn</h3>
                    ...
                    <div className="hero-image">
                        ...
                        <div className="counter-box float-bob-x">
                            <p>More than</p>
                            <h2><span className="odometer" data-count="150">
                              <Count number={150} text='+' />
                              </span></h2>
                            <p>Quality Courses</p>
                        </div>
